...
path_bin_python = Path.home().joinpath(".pyenv/shims/python3.11")
path_bin_pip = Path.home().joinpath(".pyenv/shims/pip3.11")
dir_workflow = Path.home().joinpath(
    "Documents/Alfred-Settings/Alfred.alfredpreferences/workflows/user.workflow.C1DF7995-83B4-4E10-B526-90EE7CA42A43"
)
